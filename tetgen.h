...
REAL orient4dexact(REAL* pa, REAL* pb, REAL* pc, REAL* pd, REAL* pe, REAL ah,
                   REAL bh, REAL ch, REAL dh, REAL eh);
...
#define fastlookup(pool, index)                                                \
    ...
    int*
        idx_segment_ridge_vertex_list; // are two ridge vertices form a segment?
    ...
    REAL orient4d_s(REAL*, REAL*, REAL*, REAL*, REAL*, REAL, REAL, REAL, REAL,
                    REAL);
    ...
    bool orthosphere(REAL*, REAL*, REAL*, REAL*, REAL, REAL, REAL, REAL, REAL*,
                     REAL*);
    ...
    void delaunizecavity(arraypool*, arraypool*, arraypool*, arraypool*,
                         arraypool*, arraypool*);
    bool fillcavity(arraypool*, arraypool*, arraypool*, arraypool*, arraypool*,
                    arraypool*, triface* crossedge);
    ...
    int recoverfacebyflips(point, point, point, face*, triface*, int&, point*,
                           point*);
    ...
    bool split_segment(face* splitseg, point encpt, REAL* param, int qflag, int,
                       int*);
    void repairencsegs(REAL* param, int qflag, int chkencflag);

    bool get_subface_ccent(face* chkfac, REAL* ccent);
    bool check_enc_subface(face* chkfac, point* pencpt, REAL* ccent,
                           REAL* radius);
    ...
    bool split_subface(face* splitfac, point encpt, REAL* ccent, REAL*, int,
                       int, int*);
    ...
    enum locateresult locate_point_walk(point searchpt, triface*,
                                        int chkencflag);
...
inline void terminatetetgen(tetgenmesh* m, int x)
{
    ...
    switch (x)
    {
        ...
        case 3:
            ...
            break;
        case 4:
            printf("A very small input feature size was detected. Program "
                   "stopped.\n");
            if (m)
            {
            ...
            break;
        case 5:
            printf("Two very close input facets were detected. Program "
                   "stopped.\n");
            printf("Hint: use -Y option to avoid adding Steiner points in "
                   "boundary.\n");
            break;
        case 10:
            ...
            break;
        case 200:
            printf("Boundary contains Steiner points (-YY option). Program "
                   "stopped.\n");
            break;
    } // switch (x)
    exit(x);
